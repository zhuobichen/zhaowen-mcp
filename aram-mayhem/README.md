...
**云顶报告（9 张图）**：名次分布（前四蓝/后四红）· 逐局名次折线（含 4.5 名基准）· **逐周场次与周平均名次** · **按补丁的平均名次**（与海斗同一口径，两个版本号都标）· **等级 × 名次散点**（高等级却差名次=运营问题）· 羁绊偏好 · 棋子偏好 · **装备偏好**（带它收场时的平均名次）· 羁绊组合与成绩 · 最近 20 局明细。同样支持 `--friend` 出别人的。
